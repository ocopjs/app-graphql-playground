...
## [Xem tài liệu](https://docs.ocopee.com/docs/ocopjs/references/app-graphql-playground)
...
1. Kiểm tra [Issues](https://github.com/ocopjs/app-graphql-playground/issues) hiện có
